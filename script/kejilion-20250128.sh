...
donlond_frp() {
	...
	rm -rf /home/frp/frp_0.61.1_linux_amd64
	...
	mv "$dir_name" frp_0.61.1_linux_amd64
...
generate_frps_config() {
	...
	# 创建 frps.toml 文件
	cat <<EOF > /home/frp/frp_0.61.1_linux_amd64/frps.toml
[common]
bind_port = $bind_port
...
EOF
	...
	tmux new -d -s "frps" "cd /home/frp/frp_0.61.1_linux_amd64 && ./frps -c frps.toml"
	check_crontab_installed
	crontab -l | grep -v 'frps' | crontab - > /dev/null 2>&1
	(crontab -l ; echo '@reboot tmux new -d -s "frps" "cd /home/frp/frp_0.61.1_linux_amd64 && ./frps -c frps.toml"') | crontab - > /dev/null 2>&1
...
configure_frpc() {
	...
	cat <<EOF > /home/frp/frp_0.61.1_linux_amd64/frpc.toml
[common]
...
EOF
	...
	tmux new -d -s "frpc" "cd /home/frp/frp_0.61.1_linux_amd64 && ./frpc -c frpc.toml"
	check_crontab_installed
	crontab -l | grep -v 'frpc' | crontab - > /dev/null 2>&1
	(crontab -l ; echo '@reboot tmux new -d -s "frpc" "cd /home/frp/frp_0.61.1_linux_amd64 && ./frpc -c frpc.toml"') | crontab - > /dev/null 2>&1
...
delete_forwarding_service() {
	...
	# 使用 sed 删除该服务及其相关配置
	sed -i "/\[$service_name\]/,/^$/d" /home/frp/frp_0.61.1_linux_amd64/frpc.toml
	...
	while true; do
		...
		case $choice in
			1)
				...
				;;
			2)
				cp -f /home/frp/frp_0.61.1_linux_amd64/frps.toml /home/frp/frps.toml
				donlond_frp
				cp -f /home/frp/frps.toml /home/frp/frp_0.61.1_linux_amd64/frps.toml
				tmux kill-session -t frps >/dev/null 2>&1
				tmux new -d -s "frps" "cd /home/frp/frp_0.61.1_linux_amd64 && ./frps -c frps.toml"
				crontab -l | grep -v 'frps' | crontab - > /dev/null 2>&1
				(crontab -l ; echo '@reboot tmux new -d -s "frps" "cd /home/frp/frp_0.61.1_linux_amd64 && ./frps -c frps.toml"') | crontab - > /dev/null 2>&1
...
frpc_panel() {
	...
	while true; do
		...
		echo "------------------------"
		if [ -d "/home/frp/" ]; then
			list_forwarding_services "/home/frp/frp_0.61.1_linux_amd64/frpc.toml"
		fi
		echo ""
		echo "------------------------"
		echo "1. 安装               2. 更新               3. 卸载"
		...
		case $choice in
			1)
				...
				;;
			2)
				cp -f /home/frp/frp_0.61.1_linux_amd64/frpc.toml /home/frp/frpc.toml
				donlond_frp
				cp -f /home/frp/frpc.toml /home/frp/frp_0.61.1_linux_amd64/frpc.toml
				tmux kill-session -t frpc >/dev/null 2>&1
				tmux new -d -s "frpc" "cd /home/frp/frp_0.61.1_linux_amd64 && ./frpc -c frpc.toml"
				crontab -l | grep -v 'frpc' | crontab - > /dev/null 2>&1
				(crontab -l ; echo '@reboot tmux new -d -s "frpc" "cd /home/frp/frp_0.61.1_linux_amd64 && ./frpc -c frpc.toml"') | crontab - > /dev/null 2>&1
			...
			6)
				install nano
				nano /home/frp/frp_0.61.1_linux_amd64/frpc.toml
				tmux kill-session -t frpc >/dev/null 2>&1
				tmux new -d -s "frpc" "cd /home/frp/frp_0.61.1_linux_amd64 && ./frpc -c frpc.toml"
				;;
